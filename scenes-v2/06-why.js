...
(function () {
  ...
  // (each url is written out in full: tools/build.py inlines only literal photo urls)
  const PHOTOS = [
    { img: "url('assets/photos/nouf.jpg')", pos: '22% 40%' },
    { img: "url('assets/photos/faisal.jpg')", pos: '50% 22%' },
    { img: "url('assets/photos/nouf-question.jpg')", pos: '46% 38%' },
  ];
